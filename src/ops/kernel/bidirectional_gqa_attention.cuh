...
template <bool CyclicSwa, int Window, int KeyBlock, int Threads>
...
template <bool CyclicSwa, int Window, int Tokens, int WarpsPerCta, int KeyBlock, bool DirectOutput>
__device__ __forceinline__ void noncausal_gqa_split_partial_body(
    ...
    int max_context, int split_capacity, float scale, float* __restrict__ partial_acc,
...
#pragma unroll
    ...
    bidirectional_gqa_stage_tile<CyclicSwa, Window, KeyBlock, Threads>(
...
__launch_bounds__(WarpsPerCta * 32, 2) __global__ void bidirectional_gqa_split_partial_kernel(
    ...
    int max_context, int split_capacity, float scale, float* __restrict__ partial_acc,
    float* __restrict__ partial_m, float* __restrict__ partial_l, __nv_bfloat16* __restrict__ out) {
    noncausal_gqa_split_partial_body<false, 0, Tokens, WarpsPerCta, KeyBlock, DirectOutput>(
...
__launch_bounds__(WarpsPerCta * 32, 2) __global__ void swa_split_partial_kernel(
    ...
    noncausal_gqa_split_partial_body<true, Window, Tokens, WarpsPerCta, KeyBlock, DirectOutput>(
...
template <bool CyclicSwa, int Window, int Tokens, int KeyBlock>
__device__ __forceinline__ void
noncausal_gqa_reduce_body(const float* __restrict__ partial_acc,
    ...
    if (tid < kBidirectionalGqaHeadDim) {
        ...
        for (int split = 0; split < active_splits; ++split) {
            ...
            numerator += partial_acc[bidirectional_gqa_partial_index<Tokens>(
...
__launch_bounds__(128, 2) __global__
    void bidirectional_gqa_reduce_kernel(const float* __restrict__ partial_acc,
    ...
    noncausal_gqa_reduce_body<false, 0, Tokens, KeyBlock>(partial_acc, partial_m, partial_l,
...
__launch_bounds__(WarpsPerBlock * 32, 2) __global__
    void swa_reduce_kernel(const float* __restrict__ partial_acc,
                           const float* __restrict__ partial_m, const float* __restrict__ partial_l,
