// ninfer::ops::detail - Gqa35Geometry small-T GQA kernel instantiation TU.
...
void gqa_attention_small_t_g35(const Tensor& q, const Tensor& k, const Tensor& v,
    ...
    gqa_attention_small_t_launch_for<Gqa35Geometry>(q, input, pos, scale, cache, invocation, envelope,
                                         partial_acc, partial_m, partial_l, out, stream);
}

void gqa_attention_cached_small_t_g35(const Tensor& q, const Tensor& pos, float scale,
