...
struct Variant {
    ...
    [[nodiscard]] static std::array<DType, 64> default_layer_kv_dtypes(
    ...
    [[nodiscard]] static constexpr bool dspark_weights(WeightsProfile) { return false; }
    [[nodiscard]] static constexpr bool dflash2_weights(WeightsProfile) { return false; }
