#!/usr/bin/env python3
"""_kv_bit_budget.py — given a KV bit budget (fractional), emit the best per-layer KV table.
...
Quality penalties (needle-sweep prior, lower is better; refine with _kv_matrix_v3 results):
  bf16 0.00 | int8 0.02 | fp8 0.03 | e8 0.08 | nvfp4 0.30 | iso3 0.50

Usage:
  _kv_bit_budget.py --layers 8 --bits 4.5
  _kv_bit_budget.py --layers 8 --bits 3.5 4.0 4.5 5 6 8 12 16
"""
